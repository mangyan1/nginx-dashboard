...
export function validateSite(site) {
  ...
  } else if (site.basicAuth.enabled && !users.some(u => u?.user && u?.password)) {
...
export function selfSiteWarnings(site) {
  ...
  if (site.basicAuth.enabled) {
    w.push('basic auth on top of the dashboard login means two prompts, and its password is stored in plain text in the manifest')
  }
